...
export default function CheckoutPage() {
  ...
  const validateStep = (currentStep: number): boolean => {
    if (currentStep === 1) {
      const { firstName, lastName, email, phone, address, city, postcode, country } = billingDetails;
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <Link href="/" className="inline-flex items-center gap-2 text-gray-600 hover:text-blue-600 transition w-fit font-medium">
              <FaArrowLeft className="w-4 h-4" />
              Back to Cart
            </Link>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
                  ...
                  {selectedPayment === 'apple' && (
                    <div className="mt-6 p-4 bg-gray-50 rounded-xl border border-gray-200">
                      <div className="flex items-center gap-3">
                        <FaApplePay className="w-8 h-8 text-gray-800" />
                        <div>
                          <p className="font-semibold text-gray-900">Apple Pay</p>
                          <p className="text-sm text-gray-600">Pay securely using your Apple device</p>
                        </div>
                      </div>
                    </div>
                  )}
                    ...
                    <div className="mt-6 p-4 bg-gray-50 rounded-xl border border-gray-200">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Pay securely using your Google account</p>
                        </div>
                      </div>
                    </div>
                  )}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-24 border border-gray-100">
              ...
              {/* Cart Items */}
              <div className="space-y-4 max-h-96 overflow-y-auto mb-6 pr-2 scrollbar-thin">
                {cartItems.map((item) => (
